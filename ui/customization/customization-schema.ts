...
export const DEFAULT_CUSTOMIZATION: CustomizationConfig = {
  ...
  layout: {
    ...
    toolbar: { position: "top", height: 50, autoHide: false, items: ["back", "forward", "reload", "omnibox", "bookmark", "ai"].map(id => ({ id: id as ToolbarItemId, visible: true })) },
